...
import gc.mda.signal_batch.processor.VesselTrackProcessor;
import gc.mda.signal_batch.processor.AbnormalTrackDetector;
import gc.mda.signal_batch.processor.AbnormalTrackDetector.AbnormalDetectionResult;
import gc.mda.signal_batch.reader.InMemoryVesselTrackDataReader;
import gc.mda.signal_batch.common.VesselTrackDataHolder;
import gc.mda.signal_batch.util.TrackClippingUtils;
import gc.mda.signal_batch.writer.VesselTrackBulkWriter;
import gc.mda.signal_batch.writer.AbnormalTrackWriter;
import gc.mda.signal_batch.writer.CompositeTrackWriter;
