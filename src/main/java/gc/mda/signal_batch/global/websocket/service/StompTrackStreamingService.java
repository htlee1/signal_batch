...
import gc.mda.signal_batch.domain.vessel.service.filter.VesselTrackFilter;
import gc.mda.signal_batch.domain.vessel.service.simplification.TrackSimplificationStrategy;
import gc.mda.signal_batch.domain.vessel.service.simplification.TrackSimplificationStrategy.SimplificationLevel;
import gc.mda.signal_batch.global.util.ValidationUtil;
import gc.mda.signal_batch.domain.vessel.service.VesselTrackMerger;
...
public class StompTrackStreamingService {
    ...
    private String buildStreamingQuery(TrackQueryRequest request,
        ...
        if (simplificationLevel != SimplificationLevel.NONE && simplificationLevel.getTolerance() > 0) {
            ...
            sql.append("SELECT sig_src_cd, target_id, ");
            sql.append("ST_AsText(track_geom) as track_geom_wkt, ");
        }
